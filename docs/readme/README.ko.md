...
API 키가 없으면 Ondrift의 Cloudflare 프록시를 통해 하루 10회 무료로 다시 쓸 수
있습니다. 이 하루 한도에 도달하면 옵션 페이지에서 자신의 무료 Gemini API 키를
추가해 하루 제한 없이 계속 사용할 수 있습니다. 자신의 Gemini 키를 추가한 사용자는
Ondrift 백엔드를 전혀 거치지 않고 확장 프로그램에서 Gemini로 직접 무제한
요청합니다. 계정이나 클라우드 동기화는 필요하지 않습니다.
...
Node.js 22.22.2–22.x, 24.15.0–24.x 또는 26.0.0 이상을 사용합니다.
