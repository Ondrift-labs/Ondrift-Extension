...
export const inlineMessages: Record<LanguageId, InlineMessages> = {
  ko: {
    ariaLabel: "Ondrift 프롬프트 개선", settings: "Ondrift 설정 열기", dismiss: "Ondrift 닫기", resetPosition: "위치 초기화", resizeHandle: "드래그해서 크기 조절",
  ...
  en: {
    ariaLabel: "Ondrift prompt rewrite", settings: "Open Ondrift settings", dismiss: "Dismiss Ondrift", resetPosition: "Reset position", resizeHandle: "Drag to resize",
  ...
  ja: {
    ariaLabel: "Ondrift プロンプト改善", settings: "Ondrift 設定を開く", dismiss: "Ondrift を閉じる", resetPosition: "位置をリセット", resizeHandle: "ドラッグしてサイズ変更",
  ...
  zh: {
    ariaLabel: "Ondrift 提示词改写", settings: "打开 Ondrift 设置", dismiss: "关闭 Ondrift", resetPosition: "重置位置", resizeHandle: "拖动以调整大小",
