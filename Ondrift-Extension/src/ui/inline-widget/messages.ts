...
export const inlineMessages: Record<LanguageId, InlineMessages> = {
  ko: {
    ...
    score: "점수", strong: "명확하고 구체적이에요", foundation: "기본 방향이 명확해요", needsDirection: "조금 더 구체화가 필요해요", points: "점", suggested: "개선된 프롬프트", retry: "다시 시도", apply: "프롬프트에 적용", applied: "적용되었습니다. 전송 전에 계속 수정할 수 있어요.",
  ...
  en: {
    ...
    score: "Score", strong: "Strong and specific", foundation: "Clear foundation", needsDirection: "Needs more direction", points: "points", suggested: "Suggested rewrite", retry: "Try again", apply: "Apply to prompt", applied: "Applied. You can keep editing before you send.",
  ...
  ja: {
    ...
    score: "スコア", strong: "明確で具体的です", foundation: "基本方針が明確です", needsDirection: "もう少し具体化が必要です", points: "ポイント", suggested: "改善されたプロンプト", retry: "再試行", apply: "プロンプトに適用", applied: "適用しました。送信前に引き続き編集できます。",
