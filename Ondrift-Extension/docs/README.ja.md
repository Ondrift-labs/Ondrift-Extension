...
Chrome ウェブストア公開前でも、公開リリース ZIP からインストールして利用できます。

1. [最新リリース](https://github.com/Ondrift-labs/Ondrift-Extension/releases/latest) から `ondrift-0.1.22.zip` をダウンロードします。
2. ZIP を完全に解凍します。
